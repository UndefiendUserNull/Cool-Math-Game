...
from globals import is_cheat_enabled, division_round, high_scores_path
...
def get_user_name():
    while len(globals.username) < 1:
        globals.username = input("Enter your name : ")
...
def settings():
    ...
    if chose == 1:
        ...
        division_round_input = int(input("Enter Division Round Amount : "))
